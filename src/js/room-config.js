...
export const room_config = [
	{
		...
		spotlights: [
			//new Spotlight(new Camera([3.1, 4, 1.75], -0.23441, Math.PI/4), [1.0,0.95,0.9], 1.5, [25,45], 1, [0.1,100.0]),
			new Spotlight(new Camera([3, 0.25, 0], 0, Math.PI/2), [1.0,0.95,0.9], 1.5, [25,45], 1, [0.1,100.0]),
		]
	}
]