...
export const room_config:Array<any> = [
	{
		...
		spotlights: [
			new Spotlight(new Camera([0, 6.5, 0], -Math.PI/2+0.1, 0), [1.0,0.95,0.9], 10.0, [30,65], 1, 12.0, [0.0001,0.005], [1.0,10.0]),
			// new Spotlight(new Camera([3.1, 4, 1.75], -0.23441, Math.PI/4), [1.0,0.95,0.9], 10.0, [25,45], 1, [1.0,100.0]),
			new Spotlight(new Camera([3.1, 0.35, 1.75], Math.PI/8, Math.PI/4), [1.0,0.95,0.9], 10.0, [20,65], 1, 12.0, [0.0005,0.0005], [1.0,25.0]),
