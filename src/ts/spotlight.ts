...
export class Spotlight {
	...
	constructor(	cam:					Camera,
		...
		this.o_angle = Math.cos(inner_outer_angle_deg[1]*DEG_TO_RAD/2);
		this.falloff = falloff;
		this.zplanes = zplanes;

		// construct properties
		this.proj_m = M.mat4.create();
		M.mat4.perspective(this.proj_m, this.o_angle, 1.0, this.zplanes[0], this.zplanes[1]); // !!!!!!MEGA TEMPORARY
	}
}